...
VcfFilter is part of BIOPET tool suite that is developed at LUMC by [the SASC team](http://sasc.lumc.nl/).
...
For any question related to VcfFilter, please use the
<a href='https://github.com/biopet/vcffilter/issues'>github issue tracker</a>
or contact
